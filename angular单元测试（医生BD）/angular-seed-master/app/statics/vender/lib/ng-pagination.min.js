    ...
    e.module("ng-pagination", []).constant("ngPaginationConfig", {
        ...
        return {
            link: function (n, a, g) {
                function i() {
                    var e, t, a;
                    if (n.pagenums = [], 0 !== n.pageCount)for (n.currentPage > n.pageCount && (n.currentPage = 1), n.pageCount <= o ? (e = 1, t = n.pageCount) : (a = Math.ceil(o / 2)-1, e = Math.max(n.currentPage - a, 1), t = Math.min(e + o - 1, n.pageCount), n.pageCount - t < a && (e = t - o + 1)); t >= e; e++)n.pagenums.push(e)
                }
            ...
            replace: !0,
            restrict: "E",
            scope: {pageCount: "=", currentPage: "=", onPageChange: "&"},
